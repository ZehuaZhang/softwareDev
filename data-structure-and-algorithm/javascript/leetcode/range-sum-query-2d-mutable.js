...
class NumMatrix {
    constructor(matrix) {
        ...
        this.matrix = [...Array(this.rows + 1)].map(() => Array(this.cols + 1).fill(0))
        this.bits = [...Array(this.rows + 1)].map(() => Array(this.cols + 1).fill(0))
    ...
    sumRegion(row1, col1, row2, col2) {
        return this.getSum(row2 + 1, col2 + 1) - this.getSum(row1, col2 + 1) - this.getSum(row2 + 1, col1) +
