...
// other rooms are either empty (0) or contain magic orbs that increase the knight health (positive integers).

// In order to reach the princess as quickly as possible, the knight decides to move only rightward or downward in each step.


// Write a function to determine the knight minimum initial health so that he is able to rescue the princess.
...
// The knight health has no upper bound.
